...
#ifndef KAGOME_TEST_MOCK_CORE_STORAGE_TRIE_DB_OVERLAY_MOCK_HPP
#define KAGOME_TEST_MOCK_CORE_STORAGE_TRIE_DB_OVERLAY_MOCK_HPP
...
namespace kagome::storage::trie_db_overlay {
  ...
  class TrieDbOverlayMock : public TrieDbOverlay {
   public:
    MOCK_METHOD0(
        batch,
    ...
    MOCK_METHOD1(
        sinkChangesTo,
        outcome::result<void>(blockchain::ChangesTrieBuilder &changes_trie));
  };

}  // namespace kagome::storage::trie_db_overlay

#endif  // KAGOME_TEST_MOCK_CORE_STORAGE_TRIE_DB_OVERLAY_MOCK_HPP
