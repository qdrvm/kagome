...
struct WalkBackFromBlockNodeBelow
  ...
  void SetUp() override {
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":10},"B":{"number":3,"ancestors":["A","genesis"],"descendents":[],"cumulative_vote":10}},"heads":["B"],"base":"genesis","base_number":1})");
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":15},"F1":{"number":7,"ancestors":["E1","D","C","B"],"descendents":[],"cumulative_vote":5},"B":{"number":3,"ancestors":["A","genesis"],"descendents":["F1"],"cumulative_vote":15}},"heads":["F1"],"base":"genesis","base_number":1})");
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":20},"F1":{"number":7,"ancestors":["E1","D","C","B"],"descendents":[],"cumulative_vote":5},"B":{"number":3,"ancestors":["A","genesis"],"descendents":["F1","G2"],"cumulative_vote":20},"G2":{"number":8,"ancestors":["F2","E2","D","C","B"],"descendents":[],"cumulative_vote":5}},"heads":["F1","G2"],"base":"genesis","base_number":1})");
  }
};
