...
struct WalkBackAtNode : public VoteGraphFixture,
  ...
  "base_number": 0
    ...
    ASSERT_OUTCOME_SUCCESS(graph->insert(vt, {3, "C"_H}, "w10_a"_ID));
  ...
  "base_number": 0
    ...
    ASSERT_OUTCOME_SUCCESS(graph->insert(vt, {6, "F2"_H}, "w5_b"_ID));
  ...
  "base_number": 0
    ...
    expect_getAncestry(GENESIS_HASH,
                       ...
                       vec("I1"_H,
                           ...
                           "A"_H,
                           GENESIS_HASH));
    ASSERT_OUTCOME_SUCCESS(graph->insert(vt, {9, "I1"_H}, "w1_a"_ID));
