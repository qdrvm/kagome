...
struct WalkBackFromBlockInEdgeForkBelow
  ...
  void SetUp() override {
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"B":{"number":3,"ancestors":["A","genesis"],"descendents":[],"cumulative_vote":10},"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":10}},"heads":["B"],"base":"genesis","base_number":1})");
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"B":{"number":3,"ancestors":["A","genesis"],"descendents":["F1"],"cumulative_vote":15},"F1":{"number":7,"ancestors":["E1","D1","C","B"],"descendents":[],"cumulative_vote":5},"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":15}},"heads":["F1"],"base":"genesis","base_number":1})");

    expect_getAncestry("F2"_H, "E2"_H, "D2"_H, "C"_H, "B"_H, "A"_H);
    EXPECT_OUTCOME_TRUE_1(graph->insert(BlockInfo{8, "G2"_H}, "5"_W));

    AssertGraphCorrect(
        *graph,
        R"({"entries":{"G2":{"number":8,"ancestors":["F2","E2","D2","C","B"],"descendents":[],"cumulative_vote":5},"F1":{"number":7,"ancestors":["E1","D1","C","B"],"descendents":[],"cumulative_vote":5},"B":{"number":3,"ancestors":["A","genesis"],"descendents":["F1","G2"],"cumulative_vote":20},"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":20}},"heads":["F1","G2"],"base":"genesis","base_number":1})");
  }
};
