...
TEST_F(VoteGraphFixture, GhostIntroduceBranch) {
  ...
  "base_number": 0
    ...
    expect_getAncestry(GENESIS_HASH,
                       ...
                       vec("FC"_H,
                           ...
                           "A"_H,
                           GENESIS_HASH));
    ASSERT_OUTCOME_SUCCESS(graph->insert(vt, {9, "FC"_H}, "w5_a"_ID));
  ...
  "base_number": 0
    ...
    expect_getAncestry(GENESIS_HASH,
                       ...
                       vec("ED"_H,
                           ...
                           "A"_H,
                           GENESIS_HASH));
    ASSERT_OUTCOME_SUCCESS(graph->insert(vt, {9, "ED"_H}, "w7_a"_ID));
  ...
  {  // introduce branch in the middle
    ...
    ASSERT_OUTCOME_SUCCESS(graph->insert(vt, {5, "E"_H}, "w3_a"_ID));
