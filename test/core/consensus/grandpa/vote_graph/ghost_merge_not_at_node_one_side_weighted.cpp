...
TEST_F(VoteGraphFixture, GhostMergeNotAtNodeOneSideWeighted) {
  ...
  {  // insert nodes
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"G1":{"number":8,"ancestors":["F","E","D","C","B"],"descendents":[],"cumulative_vote":100},"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":100},"B":{"number":3,"ancestors":["A","genesis"],"descendents":["G1"],"cumulative_vote":100}},"heads":["G1"],"base":"genesis","base_number":1})");
    ...
    AssertGraphCorrect(
        *graph,
        R"({"entries":{"H2":{"number":9,"ancestors":["G2","F","E","D","C","B"],"descendents":[],"cumulative_vote":150},"genesis":{"number":1,"ancestors":[],"descendents":["B"],"cumulative_vote":250},"B":{"number":3,"ancestors":["A","genesis"],"descendents":["G1","H2"],"cumulative_vote":250},"G1":{"number":8,"ancestors":["F","E","D","C","B"],"descendents":[],"cumulative_vote":100}},"heads":["G1","H2"],"base":"genesis","base_number":1})");
  }
