...
TEST_F(TransactionPoolTest, CorrectRemoveTx) {
  ...
  EXPECT_OUTCOME_SUCCESS(pool_->removeOne("02"_hash256));
  EXPECT_EQ(pool_->getStatus().waiting_num, 1);
  ASSERT_EQ(pool_->getStatus().ready_num, 1);
