...
//   activate_leaf(
//       leaf_c, test_state, [&](const auto &hash) {
//         if (hash == leaf_c.hash) {
//           return leaf_a.hash;
//         }
