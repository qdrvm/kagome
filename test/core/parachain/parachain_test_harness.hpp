...
// #include
// "parachain/validator/prospective_parachains/prospective_parachains.hpp"
...
class ProspectiveParachainsTestHarness : public testing::Test {
 protected:
  ...
  //      };
  //      EXPECT_CALL(*block_tree_,
  //      getBlockHeader(h_)).WillRepeatedly(Return(h));
  ...
  //      };
  //      EXPECT_CALL(*parachain_api_, staging_para_backing_state(hash,
  //      para_id))
  ...
  //    handle_leaf_activation_2(update, leaf, test_state,
  //    async_backing_params);
  //  }
  //
  //  void activate_leaf(const TestLeaf &leaf,
  //                     const TestState &test_state,
  //                     const fragment::AsyncBackingParams
  //                     &async_backing_params) {
  //    handle_leaf_activation(leaf, test_state, async_backing_params);
  //  }
  //
  //  void introduce_candidate(const network::CommittedCandidateReceipt
  //  &candidate,
  ...
  //    hypothetical_candidate{HypotheticalCandidateComplete{
  ...
  //                      const CandidateHash &candidate_hash,
  //                      const std::vector<std::pair<Hash,
  //                      std::vector<size_t>>>
  ...
  //    auto resp =
  //    prospective_parachain_->answerProspectiveValidationDataRequest(
