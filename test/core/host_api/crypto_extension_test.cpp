...
class CryptoExtensionTest : public ::testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    seed_buffer.put(compareWithRef2(optional_seed, ::scale::encode(optional_seed).value()));
    std::optional<std::string> optional_mnemonic(mnemonic);
    mnemonic_buffer.put(compareWithRef2(optional_mnemonic, ::scale::encode(optional_mnemonic).value()));
    ...
    scale_encoded_secp_truncated_public_key =
        Buffer(compareWithRef2(RecoverUncompressedPublicKeyReturnValue(
                                 secp_truncated_public_key), ::scale::encode(RecoverUncompressedPublicKeyReturnValue(
                                 secp_truncated_public_key))
                   .value()));

    scale_encoded_secp_compressed_public_key =
        Buffer(compareWithRef2(RecoverCompressedPublicKeyReturnValue(
                                 secp_compressed_pyblic_key), ::scale::encode(RecoverCompressedPublicKeyReturnValue(
    ...
    secp_invalid_signature_error =
        Buffer(compareWithRef2(RecoverCompressedPublicKeyReturnValue(
                                 kagome::crypto::secp256k1::
                                     secp256k1_verify_error::kInvalidSignature), ::scale::encode(RecoverCompressedPublicKeyReturnValue(
                                 kagome::crypto::secp256k1::
