...
namespace kagome::application {
  ...
  void AppConfigurationImpl::parse_general_segment(const rapidjson::Value &val) {
  ...
  void AppConfigurationImpl::parse_blockchain_segment(const rapidjson::Value &val) {
    std::string chain_spec_path_str;
    load_str(val, "chain", chain_spec_path_str);
    chain_spec_path_ = fs::path(chain_spec_path_str);
  }

  void AppConfigurationImpl::parse_storage_segment(const rapidjson::Value &val) {
    std::string base_path_str;
    load_str(val, "base-path", base_path_str);
    base_path_ = fs::path(base_path_str);
  }

  void AppConfigurationImpl::parse_network_segment(const rapidjson::Value &val) {
  ...
  void AppConfigurationImpl::parse_additional_segment(const rapidjson::Value &val) {
