...
#define WAVM_DEFINE_INTRINSIC_FUNCTION(module, nameString, Result, cName, ...) \
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_allocator_free_version_1,
                                 I32 address) {
    return st.top()->ext_allocator_free_version_1(address);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_allocator_malloc_version_1,
                                 I32 size) {
    return st.top()->ext_allocator_malloc_version_1(size);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I32 keytype,
                                 I64 seed) {
    return st.top()->ext_crypto_ed25519_generate_version_1(keytype, seed);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64 msg,
                                 I32 pubkey_data) {
    return st.top()->ext_crypto_ed25519_verify_version_1(
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I32,
                                 ext_crypto_finish_batch_verify_version_1) {
    return st.top()->ext_crypto_finish_batch_verify_version_1();
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(
      ...
      I32 sig,
      I32 msg) {
    return st.top()->ext_crypto_secp256k1_ecdsa_recover_compressed_version_1(
        sig, msg);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I32 key_type,
                                 I64 seed) {
    return st.top()->ext_crypto_sr25519_generate_version_1(key_type, seed);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_crypto_sr25519_public_keys_version_1,
                                 I32 key_type) {
    return st.top()->ext_crypto_sr25519_public_keys_version_1(key_type);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I32 key,
                                 I64 msg_data) {
    return st.top()->ext_crypto_sr25519_sign_version_1(key_type, key, msg_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64 msg,
                                 I32 pubkey_data) {
    return st.top()->ext_crypto_sr25519_verify_version_2(
        sig_data, msg, pubkey_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 void,
                                 ext_crypto_start_batch_verify_version_1) {
    return st.top()->ext_crypto_start_batch_verify_version_1();
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_trie_blake2_256_ordered_root_version_1,
                                 I64 values_data) {
    return st.top()->ext_trie_blake2_256_ordered_root_version_1(values_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_misc_print_hex_version_1,
                                 I64 values_data) {
    return st.top()->ext_misc_print_hex_version_1(values_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_misc_print_num_version_1,
                                 I64 values_data) {
    return st.top()->ext_misc_print_num_version_1(values_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_misc_print_utf8_version_1,
                                 I64 values_data) {
    return st.top()->ext_misc_print_utf8_version_1(values_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_misc_runtime_version_version_1,
                                 I64 values_data) {
    return st.top()->ext_misc_runtime_version_version_1(values_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_hashing_blake2_128_version_1,
                                 I64 data) {
    return st.top()->ext_hashing_blake2_128_version_1(data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_hashing_blake2_256_version_1,
                                 I64 data) {
    return st.top()->ext_hashing_blake2_256_version_1(data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_hashing_keccak_256_version_1,
                                 I64 data) {
    return st.top()->ext_hashing_keccak_256_version_1(data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_hashing_sha2_256_version_1,
                                 I64 data) {
    return st.top()->ext_hashing_sha2_256_version_1(data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_hashing_twox_128_version_1,
                                 I64 data) {
    return st.top()->ext_hashing_twox_128_version_1(data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_hashing_twox_64_version_1,
                                 I64 data) {
    return st.top()->ext_hashing_twox_64_version_1(data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64 key,
                                 I64 value) {
    return st.top()->ext_storage_append_version_1(key, value);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_storage_changes_root_version_1,
                                 I64 parent_hash) {
    return st.top()->ext_storage_changes_root_version_1(parent_hash);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_storage_clear_version_1,
                                 I64 key_data) {
    return st.top()->ext_storage_clear_version_1(key_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_storage_clear_prefix_version_1,
                                 I64 key_data) {
    return st.top()->ext_storage_clear_prefix_version_1(key_data);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_storage_get_version_1,
                                 I64 key) {
    return st.top()->ext_storage_get_version_1(key);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 ext_storage_next_key_version_1,
                                 I64 key) {
    return st.top()->ext_storage_next_key_version_1(key);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64 value_out,
                                 I32 offset) {
    return st.top()->ext_storage_read_version_1(key, value_out, offset);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64,
                                 ext_storage_root_version_1) {
    return st.top()->ext_storage_root_version_1();
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64 key,
                                 I64 value) {
    return st.top()->ext_storage_set_version_1(key, value);
  }
  ...
  WAVM_DEFINE_INTRINSIC_FUNCTION(env,
                                 ...
                                 I64 target,
                                 I64 message) {
    return st.top()->ext_logging_log_version_1(level, target, message);
  }
