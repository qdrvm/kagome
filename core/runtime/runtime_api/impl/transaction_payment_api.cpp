...
namespace kagome::runtime {
  ...
  TransactionPaymentApiImpl::query_info(const primitives::BlockHash &block,
    ...
    static const common::Hash64 transaction_payment_api_hash = hasher_->blake2b_64(common::Buffer::fromString("TransactionPaymentApi"));
    const auto &c_transaction_payment_api_hash = transaction_payment_api_hash; // to create memory storage to push in lambda
    auto res =
