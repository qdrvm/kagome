...
namespace kagome::network {
  ...
  template <typename Observer, typename Message>
  class ParachainProtocol final : public ProtocolBase,
                                  public std::enable_shared_from_this<
                                      ParachainProtocol<Observer, Message>>,
                                  NonCopyable,
                                  NonMovable {
   public:
    ...
    ParachainProtocol(libp2p::Host &host,
        ...
        : base_(host, {protocol}, fmt::format("Parachain [{}]", protocol)),
