...
namespace kagome::network {
  ...
  class Router {
   ...
   public:
    ...
    //     */
    //    virtual void handleSyncProtocol(std::shared_ptr<Stream> stream) const
    //    = 0;
    ...
    //     * @param stream to be handled
    //     */
    //    virtual void handleGossipProtocol(std::shared_ptr<Stream> stream)
    //    const = 0;
    ...
    //     */
    //    virtual void handleSupProtocol(std::shared_ptr<Stream> stream) const =
    //    0;
  };
}  // namespace kagome::network
