...
namespace kagome::host_api {
  ...
  void HostApiImpl::reg(WasmEdge_ImportObjectContext *ImpObj) {
    ...
    REGISTER_HOST_API_FUNC(
        HostApiImpl, ext_offchain_index_set_version_1, ImpObj);
    ...
    REGISTER_HOST_API_FUNC(
        HostApiImpl, ext_hashing_blake2_128_version_1, ImpObj);
    REGISTER_HOST_API_FUNC(
        HostApiImpl, ext_hashing_blake2_256_version_1, ImpObj);
    REGISTER_HOST_API_FUNC(
        HostApiImpl, ext_hashing_keccak_256_version_1, ImpObj);
    ...
    REGISTER_HOST_API_FUNC(
        HostApiImpl, ext_offchain_timestamp_version_1, ImpObj);
