...
namespace kagome::consensus::grandpa {
  ...
  void VotingRoundImpl::onProposal(const SignedMessage &proposal,
    ...
    SL_DEBUG(logger_,
             "Round #{}: Proposal received for block {} from {}",
             round_number_,
  ...
  bool VotingRoundImpl::onPrevote(const SignedMessage &prevote,
    ...
    SL_DEBUG(logger_,
             "Round #{}: Prevote received for block {} from {} ",
             round_number_,
  ...
  bool VotingRoundImpl::onPrecommit(const SignedMessage &precommit,
    ...
    SL_DEBUG(logger_,
             "Round #{}: Precommit received for block {} from {} ",
             round_number_,
    ...
    if (best_final_candidate_.has_value()) {
      if (best_final_candidate_ != bestPrevoteCandidate()) {
        ...
        if (ghost.has_value()
          ...
          SL_TRACE(
              logger_,
              "Round #{}: updateCompletability <- precommit_ghost {} based on "
