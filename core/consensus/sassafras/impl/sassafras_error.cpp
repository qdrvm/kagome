...
OUTCOME_CPP_DEFINE_CATEGORY(kagome::consensus::sassafras, SassafrasError, e) {
  using E = kagome::consensus::sassafras::SassafrasError;
  switch (e) {
  ...
  return "unknown error (kagome::consensus::sassafras::SassafrasError)";
}
