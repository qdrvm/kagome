...
public:
    virtual ~IReportStackIterator() = default;
...
public:
    virtual ~IReportMethodIterator() = default;
...
public:
    virtual ~IReportThreadIterator() = default;
