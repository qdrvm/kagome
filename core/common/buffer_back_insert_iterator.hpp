 ...
 */
template <>
class std::back_insert_iterator<kagome::common::Buffer> {
 ...
 public:
  ...
  constexpr explicit back_insert_iterator(Buffer &c) : buf_{c} {}
  ...
  back_insert_iterator<Buffer> &operator=(uint64_t value) {
