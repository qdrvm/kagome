...
#ifndef KAGOME_YAMUXED_CONNECTION_IMPL_HPP
#define KAGOME_YAMUXED_CONNECTION_IMPL_HPP
...
namespace libp2p::muxer {
  ...
  class YamuxedConnection
      : public transport::MuxedConnection,
   ...
   public:
    ...
    YamuxedConnection(std::shared_ptr<transport::Connection> connection,
                      std::function<connection::Stream::Handler> stream_handler,
   ...
   private:
    ...
    std::function<connection::Stream::Handler> new_stream_handler_;
    bool is_active_;
...
OUTCOME_HPP_DECLARE_ERROR(libp2p::muxer, YamuxedConnection::YamuxErrorStream)

#endif  // KAGOME_YAMUXED_CONNECTION_IMPL_HPP
