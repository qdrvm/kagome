...
namespace libp2p::multi {
  ...
  auto Multihash::createFromBuffer(const Buffer &b)
    ...
    if (hash.size() != length) {
      ...
      return Error::kInconsistentLength;
    }
