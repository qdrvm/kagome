...
namespace kagome::hash {
  class Hasher {
   ...
   public:
     ...
     */
    NODISCARD virtual Hash128 twox_128(const Buffer &buffer) const = 0;
     ...
     */
    NODISCARD virtual Hash256 twox_256(const Buffer &buffer) const = 0;
     ...
     * @return 256-bit hash value
     */
    NODISCARD virtual Hash256 blake2_256(const Buffer &buffer) const = 0;
     ...
     * @return 256-bit hash value
     */
    NODISCARD virtual Hash256 sha2_256(const Buffer &buffer) const = 0;
  };
}  // namespace kagome::hash
