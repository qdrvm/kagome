...
#include "parachain/validator/backing_implicit_view.hpp"
      ...
      gsl::span<const Hash> kagome::parachain::ImplicitView::AllowedRelayParents::allowedRelayParentsFor(
     ...
     gsl::span<const Hash> kagome::parachain::ImplicitView::knownAllowedRelayParentsUnder(
    ...
    outcome::result<std::vector<ParachainId>> kagome::parachain::ImplicitView::activate_leaf(const Hash &leaf_hash) {
        /// TODO(iceseer): do
        ///
