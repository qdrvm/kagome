...
#include "parachain/validator/statement_distribution/singlethread_statement_distribution.hpp"
...
#define COMPONENT_NAME "SingleThreadStatementDistribution"

OUTCOME_CPP_DEFINE_CATEGORY(kagome::parachain::statement_distribution,
                            SingleThreadStatementDistribution::Error,
                            e) {
  using E = kagome::parachain::statement_distribution::
      SingleThreadStatementDistribution::Error;
  switch (e) {
...
namespace kagome::parachain::statement_distribution {
  ...
  SingleThreadStatementDistribution::SingleThreadStatementDistribution(
  ...
  bool SingleThreadStatementDistribution::tryStart() {
    SL_INFO(logger, "SingleThreadStatementDistribution subsystem started.");
  ...
  void SingleThreadStatementDistribution::on_peer_connected(
      const libp2p::peer::PeerId &peer) {
    auto _ = peers[peer];
  }

  void SingleThreadStatementDistribution::on_peer_disconnected(
      const libp2p::peer::PeerId &peer) {
    peers.erase(peer);
  }

  outcome::result<std::optional<std::shared_ptr<IValidatorSigner>>>
  SingleThreadStatementDistribution::is_parachain_validator(
      const primitives::BlockHash &relay_parent) const {
    return signer_factory->at(relay_parent);
  }

  outcome::result<void> SingleThreadStatementDistribution::handle_view_event(
  ...
  void SingleThreadStatementDistribution::handle_active_leaves_update(
      const network::ExView &event,
      std::vector<RelayParentContext> new_contexts) {
    SL_TRACE(logger,
  ...
  outcome::result<void>
  SingleThreadStatementDistribution::handle_active_leaves_update_inner(
      const network::ExView &event,
      std::vector<RelayParentContext> new_contexts) {
  ...
  outcome::result<void>
  SingleThreadStatementDistribution::handle_deactive_leaves_update_inner(
  ...
  SingleThreadStatementDistribution::determine_groups_per_para(
  ...
  bool SingleThreadStatementDistribution::can_disconnect(
      const libp2p::PeerId &peer) const {
  ...
  SingleThreadStatementDistribution::tryGetStateByRelayParent(
  ...
  SingleThreadStatementDistribution::getStateByRelayParent(
      const primitives::BlockHash &relay_parent) {
  ...
  void SingleThreadStatementDistribution::OnFetchAttestedCandidateRequest(
  ...
  void SingleThreadStatementDistribution::handle_peer_view_update(
  ...
  outcome::result<void>
  SingleThreadStatementDistribution::handle_grid_statement(
  ...
  SingleThreadStatementDistribution::local_knowledge_filter(
      size_t group_size,
  ...
  void SingleThreadStatementDistribution::request_attested_candidate(
      const libp2p::peer::PeerId &peer,
  ...
  bool SingleThreadStatementDistribution::validate(
  ...
  void SingleThreadStatementDistribution::handle_response(
  ...
  void SingleThreadStatementDistribution::apply_post_confirmation(
  ...
  void SingleThreadStatementDistribution::send_cluster_candidate_statements(
  ...
  void SingleThreadStatementDistribution::handle_backed_candidate_message(
      const CandidateHash &candidate_hash) {
  ...
  void SingleThreadStatementDistribution::handle_incoming_acknowledgement(
  ...
  SingleThreadStatementDistribution::acknowledgement_and_statement_messages(
      const libp2p::peer::PeerId &peer,
  ...
  void SingleThreadStatementDistribution::handle_incoming_manifest(
      const libp2p::peer::PeerId &peer_id,
  ...
  SingleThreadStatementDistribution::post_acknowledgement_statement_messages(
  ...
  SingleThreadStatementDistribution::ManifestImportSuccessOpt
  SingleThreadStatementDistribution::handle_incoming_manifest_common(
      const libp2p::peer::PeerId &peer_id,
      const CandidateHash &candidate_hash,
      const RelayHash &relay_parent,
  ...
  void SingleThreadStatementDistribution::
      new_confirmed_candidate_fragment_chain_updates(
          const HypotheticalCandidate &candidate) {
    fragment_chain_update_inner(std::nullopt, std::nullopt, {candidate});
  }

  void SingleThreadStatementDistribution::new_leaf_fragment_chain_updates(
  ...
  void SingleThreadStatementDistribution::process_frontier(
  ...
  void SingleThreadStatementDistribution::request_hypotetical_membership(
  ...
  void SingleThreadStatementDistribution::fragment_chain_update_inner(
  ...
  void SingleThreadStatementDistribution::provide_candidate_to_grid(
      const CandidateHash &candidate_hash,
      PerRelayParentState &relay_parent_state,
  ...
  void SingleThreadStatementDistribution::send_backing_fresh_statements(
  ...
  SingleThreadStatementDistribution::handle_cluster_statement(
      const RelayHash &relay_parent,
  ...
  void SingleThreadStatementDistribution::handle_incoming_statement(
      const libp2p::peer::PeerId &peer_id,
  ...
  SingleThreadStatementDistribution::check_statement_signature(
  ...
  void SingleThreadStatementDistribution::circulate_statement(
      const RelayHash &relay_parent,
      PerRelayParentState &relay_parent_state,
      const IndexedAndSigned<network::vstaging::CompactStatement> &statement) {
    const auto &session_info =
  ...
  void SingleThreadStatementDistribution::share_local_statement(
      const primitives::BlockHash &relay_parent,
  ...
  void SingleThreadStatementDistribution::send_pending_grid_messages(
      const RelayHash &relay_parent,
      const libp2p::peer::PeerId &peer_id,
      network::CollationVersion version,
  ...
  void SingleThreadStatementDistribution::send_pending_cluster_statements(
      const RelayHash &relay_parent,
      const libp2p::peer::PeerId &peer_id,
      network::CollationVersion version,
      ValidatorIndex peer_validator_id,
  ...
  std::optional<std::pair<std::vector<libp2p::peer::PeerId>,
                          network::VersionedValidatorProtocolMessage>>
  SingleThreadStatementDistribution::pending_statement_network_message(
      const StatementStore &statement_store,
      const RelayHash &relay_parent,
      const libp2p::peer::PeerId &peer,
      network::CollationVersion version,
  ...
  void SingleThreadStatementDistribution::send_peer_messages_for_relay_parent(
  ...
  SingleThreadStatementDistribution::find_active_validator_state(
      ValidatorIndex validator_index,
      const Groups &groups,
      const std::vector<runtime::CoreState> &availability_cores,
      const runtime::GroupDescriptor &group_rotation_info,
