...
namespace kagome::parachain::statement_distribution {
  ...
  class SingleThreadStatementDistribution
      : public std::enable_shared_from_this<SingleThreadStatementDistribution>,
   ...
   public:
    ...
    SingleThreadStatementDistribution(
   ...
   private:
    log::Logger logger =
        log::createLogger("SingleThreadStatementDistribution", "parachain");
