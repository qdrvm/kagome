...
namespace kagome::api::chain::request {
  ...
  struct GetHeader final : RequestType<primitives::BlockHeader, boost::optional<std::string>> {
    using BaseType = RequestType<primitives::BlockHeader, boost::optional<std::string>>;
