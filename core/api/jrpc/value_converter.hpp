...
namespace kagome::api {
  ...
  inline jsonrpc::Value makeValue(std::nullptr_t) {
    return jsonrpc::Value();
  }
  inline jsonrpc::Value makeValue(std::nullopt_t) {
    return jsonrpc::Value();
  }
  inline jsonrpc::Value makeValue(boost::none_t) {
    return jsonrpc::Value();
  }
