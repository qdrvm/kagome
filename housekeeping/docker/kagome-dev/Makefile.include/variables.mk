...
RUNTIME_VERSION := $(CURRENT_DATE)-$(shell echo "`python3 get_wasmedge_version.py`")-$(ARCHITECTURE)
...
ASANUBSAN_PARAMS ?= -DCLEAR_OBJS=ON -DCMAKE_TOOLCHAIN_FILE=cmake/toolchain/gcc-13_cxx20.cmake -DASAN=ON -DUBSAN=ON -DUBSAN_TRAP=OFF -DUBSAN_ABORT=ON
SAN_PARAMS ?= -DCLEAR_OBJS=ON -DCMAKE_TOOLCHAIN_FILE=cmake/toolchain/gcc-13_cxx20.cmake -DASAN=ON
