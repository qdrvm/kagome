...
function(addtest test_name)
  add_library(${test_name} ${ARGN})
  target_link_libraries(${test_name}
      GTest::gmock_main
      )
  add_executable(${test_name}_exe $<TARGET_OBJECTS:${test_name}>)
  set_target_properties(${test_name}_exe PROPERTIES OUTPUT_NAME ${test_name})
  if(TEST_SHARED_LIBRARY)
    target_link_libraries(${test_name}_exe libtest)
  else()
    target_link_libraries(${test_name}_exe ${test_name})
  endif()
  file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/xunit)
  set(xml_output "--gtest_output=xml:${CMAKE_BINARY_DIR}/xunit/xunit-${test_name}.xml")
  add_test(
      NAME ${test_name}
      COMMAND $<TARGET_FILE:${test_name}_exe> ${xml_output}
  )
  set_target_properties(${test_name}_exe PROPERTIES
      RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/test_bin
      )
  disable_clang_tidy(${test_name})
  set_property(GLOBAL APPEND PROPERTY tests ${test_name})
endfunction()
