...
int main(int argc, char **argv) {
  ...
  configuration->initialize_from_args(AppConfiguration::LoadScheme::kValidating, argc, argv);
  auto &&app = std::make_shared<kagome::application::ValidatingNodeApplication>(std::move(configuration));
  app->run();
